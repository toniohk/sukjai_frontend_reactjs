 ...
 function initZabor() {
    ...
    function setUpCarouselSlider() {
         ...
         var j2 = new Swiper(".fw-carousel .swiper-container", {
             ...
             pagination: {
                 ...
                 renderFraction: function(currentClass) {
                     return '<span className="' + currentClass + '"></span>' + '' + '<span className="j2total">' + totalSlides2 + '</span>';
                 }
             },
             navigation: {
     ...
     $.ajaxChimp.translations.eng = {
         submit: "Submitting...",
         0: '<i className="fa fa-check"></i> We will be in touch soon!',
         1: '<i className="fa fa-warning"></i> You must enter a valid e-mail address.',
         2: '<i className="fa fa-warning"></i> E-mail address is not valid.',
         3: '<i className="fa fa-warning"></i> E-mail address is not valid.',
         4: '<i className="fa fa-warning"></i> E-mail address is not valid.',
         5: '<i className="fa fa-warning"></i> E-mail address is not valid.'
     };
     //   Video------------------
